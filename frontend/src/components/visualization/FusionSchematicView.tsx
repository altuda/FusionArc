...
const getDatabaseUrl = (source: string, accession: string | undefined): string | null => {
  ...
  if (sourceLower === 'cdd') return `https://www.ncbi.nlm.nih.gov/Structure/cdd/cddsrv.cgi?uid=${accession}`
...
const SOURCE_COLORS: Record<string, string> = {
  ...
  'Superfamily': '#F59E0B', 'superfamily': '#F59E0B', 'CDD': '#8B5CF6', 'cdd': '#8B5CF6',
  'PANTHER': '#EC4899', 'panther': '#EC4899', 'Gene3D': '#06B6D4', 'gene3d': '#06B6D4',
  'Prosite_profiles': '#84CC16', 'Prosite_patterns': '#84CC16', 'PROSITE': '#84CC16',
